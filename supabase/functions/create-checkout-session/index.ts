    ...
    const sessionResponse = await fetch(
      "https://api.stripe.com/v1/checkout/sessions",
      {
        ...
        body: new URLSearchParams({
          ...
          success_url: `${Deno.env.get("NEXT_PUBLIC_APP_URL") || "https://api-schedulr.com"}/dashboard?session_id={CHECKOUT_SESSION_ID}`,
          cancel_url: `${Deno.env.get("NEXT_PUBLIC_APP_URL") || "https://api-schedulr.com"}`,
          "metadata[user_id]": user.id,
